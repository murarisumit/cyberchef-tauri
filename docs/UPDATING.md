...
4. Review wrapper-specific customizations before building:
   ...
   - Re-check that the About panel carries the new CyberChef version
...
6. Manually sanity-check the built app:
   ...
   - `CyberChef → About CyberChef` shows the wrapper version and the new
     vendored CyberChef version, e.g. `Version 0.1.5 (CyberChef 11.2.0)`
